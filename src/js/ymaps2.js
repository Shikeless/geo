...
function mapInit() {
    ...
    ymaps.ready(() => {
        ...
        map.events.add('click', function (e) {
            ...
            obj = {};
            console.log('obj во время клика', obj);
            ...
            geoCoords
                .then(code => {
                    ...
                    addPopup(mouseX, mouseY, obj.adress, obj);
                })
        ...
        but.addEventListener('click', e => {
                ...
                console.log('hint', myPlacemark.properties._data.hintContent);

                dat1.list.push(obj);

                obj = {};
                console.log('obj после отчитки, после кнопки добавить', obj);
